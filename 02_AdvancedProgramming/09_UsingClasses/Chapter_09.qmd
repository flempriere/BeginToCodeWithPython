...
We have to make one change to the pattern of the Tiny Contacts which is to account for the fact that length is a positive number. To do this we use `0` rather than `"."` to indicate that the variable should be left unchanged
