# Example 11.12 c Stock Item
#
# Contains the Stock Item class augmented with a tags field
...
class StockItem(abc.ABC):
    ...
    def __init__(self, stock_ref, price, colour, location, tags):
        """
...
class Dress(StockItem):
    ...
    tags : set[str]
        set of tags describing the item
    ...
    def __init__(self, stock_ref, price, colour, pattern, size, location, tags):
        """
        ...
        location : str
            place where the dress is located
        tags : set[str]
            set of tags describing the dress
        """
        if StockItem.show_instrumentation:
            print("**Dress __init__ called")
        super().__init__(stock_ref, price, colour, location, tags)
...
class Pants(StockItem):
    ...
    location : str
        description of where the pants are located
    tags : set[str]
        set of tags describing the pants
    ...
    def __init__(
        self, stock_ref, price, colour, pattern, length, waist, location, tags
    ):
        """
...
class Jeans(Pants):
    ...
    location : str
        description of where the pants are located
    tags : set[str]
        set of tags describing the jeans
    ...
    def __init__(
        self, stock_ref, price, colour, pattern, length, waist, style, location, tags
    ):
        """
...
class Hat(StockItem):
    ...
    tags : set[str]
        set of tags describing the hat
    ...
    def __init__(self, stock_ref, price, colour, size, location, tags):
        """
...
class Blouse(StockItem):
    ...
    tags : set[str]
        set of tags describing the blouse
    ...
    def __init__(self, stock_ref, price, colour, pattern, style, size, location, tags):
        """
