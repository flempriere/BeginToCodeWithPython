...
- Python’s socket module provides methods to find the IP of the computer
  ...
  ```
      ...
      The IP address of this computer is: 10.1.1.175
      Listening...
...
- Returns an XML document containing recent blog posts
  ...
  ```
      ...
      b'<!--Generated by Site-Server v@build.version@ (http://www.squarespace.com) on Mon, 09 Mar 2026 22:13:30 GMT\n'
      b'--><rss xmlns:content="http://purl.org/rss/1.0/modules/content/" xmlns:wfw="http://wellformedweb.org/CommentAPI/" xmlns:itunes="http://www.itunes.com/dtds/podcast-1.0.dtd" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:media="http://www.rssboard.org/media-rss" version="2.0"><channel><title>robmiles.com</title><link>https://www.robmiles.com/</link><lastBuildDate>Mon, 09 Mar 2026 22:12:07 +0000</lastBuildDate><language>en-GB</language><generator>Site-Server v@build.version@ (http://www.squarespace.com)</generator><description><![CDATA[]]></description><item><title>Superpower</title><category>Life</category><dc:creator>Rob Miles</dc:creator><pubDate>Mon, 09 Mar 2026 22:12:48 +0000</pubDate><link>https://www.robmiles.com/journal/2026/3/9/superpower</link><guid isPermaLink="false">5019271be4b0807297e8f404:52c5bcfce4b0c4bcc9121347:69af45b7f8a8bc3d726389a3</guid><description><![CDATA[<p class="">Turns out that I do have a superpower. I can get \xe2\x80\x9chat hair\xe2\x80\x9d without needing to wear a hat. </p>]]></description></item><item><title>Monitor Success</title><category>Retro gaming</category><dc:creator>Rob Miles</dc:creator><pubDate>Sun, 08 Mar 2026 17:38:05 +0000</pubDate><link>https://www.robmiles.com/journal/2026/3/8/monitor-success</link><guid isPermaLink="false">5019271be4b0807297e8f404:52c5bcfce4b0c4bcc9121347:69adb0abe71c9d712f852f78</guid><description><![CDATA[<figure class="\n'
...
- You may like the example output below
      ...
      ValueError: temperatures must be of length 7
      ---------------------------------------------------------------------------
      ValueError                                Traceback (most recent call last)
      Cell In[8], line 175
          172 latitude = 47.61
          173 longitude = -122.33
      --> 175 max_t, min_t, apparent_t, dew_p = get_weather_temp(latitude, longitude)
          177 days_table_hdr = "\t".join(
          178     map(lambda a: str(a)[:2], max_t)
          179 )  # slice of the first two characters of the day of the week
          180 max_t_str = "\t".join(map(str, max_t.values()))

      Cell In[8], line 165, in get_weather_temp(latitude, longitude)
          160         min_temp = get_temp_list(d)
          162 today = datetime.datetime.today().weekday()
          163 return (
          164     make_seven_day_forecast(today, max_temp),  # type: ignore
      --> 165     make_seven_day_forecast(today, min_temp),  # type: ignore
          166     apparent_temp,  # type: ignore
          167     dew_point,  # type: ignore
          168 )

      Cell In[8], line 65, in make_seven_day_forecast(start_date, temperatures)
           42 """
           43 Converts a sequence of temperatures into a forecast based
           44 on a current date
         (...)     62     day of the week and the temperature. Ordered from current day to current day + 6
           63 """
           64 if len(temperatures) != 7:
      ---> 65     raise ValueError("temperatures must be of length 7")
           67 # not pythonic but consistent with what we've seen so far
           68 dictionary = {}
