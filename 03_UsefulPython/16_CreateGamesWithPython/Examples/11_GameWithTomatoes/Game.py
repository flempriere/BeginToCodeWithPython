...
enemy tomatoes that will chase down the player
"""
...
class CrackerChase:
    ...
    map to collect crackers. The player will be chased by killer tomatoes.

    Currently there are no interactions for when a tomato intercepts a player
