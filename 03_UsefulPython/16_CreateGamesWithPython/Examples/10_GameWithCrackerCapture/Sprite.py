"""
Example 16.10b Sprite

Adds code for determining if two sprites intersect. Updates the Cracker
class to use this intersection code to determine if it has been caught
by the player
"""
