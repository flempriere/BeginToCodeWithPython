...
def display_message(
    text, size=200, margin=20, horiz="center", vert="center", color=(255, 0, 0)
):
    """
...
def get_weather_temp(latitude, longitude):
    ...
    """
    url = "http://forecast.weather.gov/MapClick.php?lat={0}&lon={1}&unit=0&lg=english&FcstType=dwml".format(
        latitude, longitude
    )
