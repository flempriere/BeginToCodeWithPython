...
- For example: [Displaying Images](./Examples/06_DisplayingImages/displayImage.py)
...
- See the example in [Playing Sounds](./Examples/07_PlaySound/playSound.py)
...
Lets use the `snaps` program to make a GUI version of our [egg timer program](#make-something-happen-make-an-egg-timer)
