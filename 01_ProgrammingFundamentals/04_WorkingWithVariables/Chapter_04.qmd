...
1. *Modify the [program](#exercise-calculating-a-pizza-order) return an `int` by calling `int` directly on `pizza_count`. What potential problems does this solution have?*
