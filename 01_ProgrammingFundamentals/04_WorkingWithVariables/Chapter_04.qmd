...
*Consider the previous [example](#configurable-egg-timer), and answer the following questions*
...
As we can see most the actual getting of the temperature and weather data is the same as for the Seattle [Temperature](#seattle-temperature) and [Weather](#seattle-weather) programs.
