...
*Consider the following [program](./Examples/05_PizzaOrderCalculator/PizzaOrderCalculator.py) which is designed to calculate the number of pizzas needed for a hackathon with* $x$ *number of participants using the heuristic that* $1$ *pizza can satisfy* $1.5$ *people*
...
print("\033[0mThe temperature is", -32 / 1.8, "degrees Celsius")
```
