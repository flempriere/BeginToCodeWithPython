...
2. [Ultra Precise Egg Timer](./Exercises/02_BTCInputApplications/UltraPreciseEggTimer.py)
...
3. [Pizza Order Calculator](./Exercises/02_BTCInputApplications/PizzaOrderCalculator.py)
...
4. [Fahrenheit To Celcius](./Exercises/02_BTCInputApplications/FahrenheitToCelcius.py)
...
6. [User Selected Times Tables](./Exercises/02_BTCInputApplications/TimesTables.py)
